...
CREATE TABLE `document_categories` (
  ...
  `deadline_day` int(11) DEFAULT NULL COMMENT 'Day of month when submission is due',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `submissions` (
  ...
  `user_id` int(11) NOT NULL COMMENT 'Who submitted',
...
CREATE TABLE `submission_history` (
  ...
  `action` varchar(50) NOT NULL COMMENT 'status change, remark added, etc.',
...
--
ALTER TABLE `submissions`
  ADD CONSTRAINT `submissions_ibfk_1` FOREIGN KEY (`document_category_id`) REFERENCES `document_categories` (`id`),
...
--
ALTER TABLE `submission_history`
  ADD CONSTRAINT `submission_history_ibfk_1` FOREIGN KEY (`submission_id`) REFERENCES `submissions` (`id`),
  ADD CONSTRAINT `submission_history_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
