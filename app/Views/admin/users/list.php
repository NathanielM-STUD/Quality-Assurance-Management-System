...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="<?= base_url('admin/users/new') ?>" class="btn btn-sm btn-outline-primary">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <form action="<?= base_url("admin/users/reset-password/{$user['id']}") ?>" method="post" class="d-inline">
                        <?= csrf_field() ?>
